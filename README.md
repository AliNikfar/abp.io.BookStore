...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ca6a0658-601d-42fe-a6aa-2d86651526ec
```

> `ca6a0658-601d-42fe-a6aa-2d86651526ec` is the password of the certificate, you can change it to any password you want.
